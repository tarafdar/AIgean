...
#pragma HLS DATAFLOW
    ...
    _conv_2d_large_stream_norm_nobias_pool<INPUT_T, POOL_LAYER_T, CONV_LAYER_T, CONFIG_CONV, CONFIG_POOL, N_INPUT, N_OUTPUT, N_CONV_OUTPUT> (input, output, WEIGHTS, SCALES, BIASES); 
